...
import org.firstinspires.ftc.teamcode.shooter.StupidOneDirectionMotor
...
interface ShooterProviders {
    ...
    @Provides
    @Named("shooter")
    fun provideShooterMotor(map: HardwareMap): DcMotorEx = StupidOneDirectionMotor(map.getCast("shooter"))
